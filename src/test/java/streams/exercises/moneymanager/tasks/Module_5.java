...
import streams.exercises.moneymanager.TransactionChecker;
...
@DisplayName("Module 5: Checking for invalid transactions")
class Module_5 {
    ...
    class FindInvalidTransactionsWithEmptyCounterparties {
        ...
        void whenACounterpartyIsNull() {
            ...
            assertThat(streams.exercises.moneymanager.solutions.TransactionChecker.from(transactionFeed).hasInvalidTransactions()).isTrue();
        }
    }
}
